...
from routers import players, stats, leaders, ai, analytics, projections, advanced, formations, matchups, leagues, schedule_projections
...
app.include_router(schedule_projections.router)
