...
def main():
    ...
    print("[6/7] Participation (formations & personnel)")
    try:
    ...
    # 7. Play-by-Play (pass/run snaps for matchup analysis)
    print("[7/7] Play-by-Play")
    try:
        from src.ingest.pbp import ingest_pbp
        ingest_pbp(seasons)
    except Exception as e:
